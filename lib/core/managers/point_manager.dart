...
class PointManager with ChangeNotifier {
  ...
  Future<void> _updateQuizStats(int correctAnswers) async {
    try {
      ...
      // ✅ FIX: শুধুমাত্র received correctAnswers add করুন
      ...
      // ✅ DEBUG: Current values print করুন
      print(
        '🔄 Current Correct: $currentCorrect + New: $correctAnswers = Total: ${currentCorrect + correctAnswers}',
      );
    } catch (e) {
      print(
        _getText(
