...
import '../../../core/constants/app_colors.dart'; // নতুন কালার সিস্টেম ইম্পোর্ট
...
class _IfterTimePageState extends State<IfterTimePage>
  ...
  Widget _buildAdjustmentDialog(
    ...
    final bool isMediumMobile = screenWidth < 400;

    return AlertDialog(
      backgroundColor: AppColors.getCardColor(isDarkMode),
      insetPadding: EdgeInsets.all(isSmallMobile ? 12 : 16),
      // ✅ Responsive padding
      contentPadding: EdgeInsets.all(isSmallMobile ? 16 : 20),
      ...
      actionsPadding: EdgeInsets.all(isSmallMobile ? 12 : 16),
            ...
            Expanded(
              child: Text(
                ...
                style: TextStyle(
                  ...
                  fontSize: isSmallMobile ? 16 : (isMediumMobile ? 17 : 18),
        ...
        child: Column(
          ...
          children: [
            Text(
              ...
              style: TextStyle(
                fontSize: isSmallMobile ? 12 : (isMediumMobile ? 13 : 14),
      ...
      actions: [
        Flexible(
          // ✅ Make buttons flexible for small screens
          child: Row(
            children: [
              Expanded(
                child: TextButton(
