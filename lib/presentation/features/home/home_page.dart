...
// আপনার সব imports
import '../dua/ifter_time_page.dart';
import '../../screens/profile_screen.dart';
import '../../screens/qiblah_page.dart';
import '../knowledge/mcq_page.dart';
import '../knowledge/islamic_history_page.dart';
import '../knowledge/prophet_biography_page.dart';
import '../prayer/prayer_time_page.dart';
import '../dua/doya_category_page.dart';
import '../quran/nadiyatul_quran.dart';
import '../quran/sura_page.dart';
import '../knowledge/name_of_allah_page.dart';
import '../knowledge/kalema_page.dart';
import '../../../core/utils/utils.dart';
import '../../../core/constants/ad_helper.dart';
import '../tasbih/tasbeeh_page.dart';
import '../../providers/theme_provider.dart';
import '../../providers/language_provider.dart';
import '../../../core/utils/responsive_utils.dart';
import '../../widgets/common/bottom_nav_bar.dart';
import '../../widgets/common/drawer_menu.dart';
import '../quran/quran_verse_scroller.dart';
import '../quran/word_by_word_quran_page.dart';
...
class _HomePageState extends State<HomePage>
      ...
      child: Scaffold(
        ...
        appBar: AppBar(
          title: ResponsiveText(
            ...
            fontSize: tablet ? 24 : 22, // Reduced font size
  ...
  // COMPACT CATEGORY SELECTOR - UPDATED FONT SIZES
  Widget _buildCompactCategorySelector(bool isDarkMode, bool tablet) {
    ...
    if (languageProvider.isLoading ||
      ...
      return Container(
        height: tablet ? 90 : 80, // Increased height
        alignment: Alignment.center,
          ...
          child: Column(
            ...
            children: [
              ResponsiveText(
                ...
                fontSize: tablet ? 20 : 16, // Increased from 18:13 to 20:16
                fontWeight: FontWeight.bold,
              ...
              // Compact Dropdown - UPDATED FONT SIZES
              Container(
              ...
              // Compact Button - UPDATED
              SizedBox(
                height: tablet ? 45 : 40, // Increased height
                  ...
                  label: FittedBox(
                    ...
                    child: ResponsiveText(
                      languageProvider.isEnglish
                          ? 'Start Quiz'
                          : 'কুইজ শুরু করুন',
                      fontSize: _getUpdatedButtonFontSize(context),
                      // Updated method
                      fontWeight: FontWeight.bold,
                      color: Colors.white,
                    ),
  ...
  // UPDATED Helper method for button font size
  double _getUpdatedButtonFontSize(BuildContext context) {
          ...
          child: Column(
            ...
            children: [
              ...
              Text(
                title,
                style: TextStyle(
                  fontSize: isTablet ? 18 : 12, // ← আইকন সাইজ বড় করা
                  fontWeight: FontWeight.bold,
                  color: textColor,
                  height: 1.1,
                ),
              ...
              children: [
                ...
                Expanded(
                  child: Text(
                    ...
                    style: TextStyle(
                      fontSize: isTablet ? 20 : 16, // Increased
                      fontWeight: FontWeight.bold,
                      color: textColor,
                    ),
                  ),
