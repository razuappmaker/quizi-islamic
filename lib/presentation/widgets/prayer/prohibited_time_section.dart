...
class ProhibitedTimeSection extends StatelessWidget {
  ...
  TableRow _buildTableTimeRow(
    ...
    // ভাষা অনুযায়ী সময় ফরম্যাট করুন
    String displayTime;
    if (!languageProvider.isEnglish) {
      displayTime = prohibitedTimeService.formatTimeToBangla(time);
    } else {
      displayTime = prohibitedTimeService.formatTimeToEnglish(time);
    }
          ...
          child: FittedBox(
            ...
            child: Text(
              ...
              style: TextStyle(
                ...
                fontFamily: languageProvider.isEnglish ? null : 'SiyamRupali',
                letterSpacing: languageProvider.isEnglish ? 0.5 : 0.0,
              ),
              maxLines: 1,
            ),
          ),
